  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        >
          <Toolbar style={{marginLeft:"5rem"}} disableGutters={!this.state.open}>
        ...
        >
          ...
          src={W} alt="altimgprofile"/></Paper>
          </Grid>
          <Grid item>
          <Typography
          variant='h6'
          style={{position:"absolute", marginLeft:"1rem",marginTop:"1rem"}}>
          UserName
          </Typography>
          </Grid>
          </Grid>
          ...
          <Divider />
          <List>
          <ListItem render = {this.props.isSignedIn} button component = {Link} to='/profile' key='My Profile'>
            <ListItemIcon>
            <Person />
            </ListItemIcon>
